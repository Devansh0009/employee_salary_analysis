...
# ----------------- Constants ------------------
MODEL_DIR = "models"
MODEL_PATH = os.path.join(MODEL_DIR, "/content/best_model.pkl")
ENCODER_PATH = os.path.join(MODEL_DIR, "/content/labelencoding.pkl")
...
df = pd.read_csv("/content/adult 3.csv")  # Load once for schema validation
